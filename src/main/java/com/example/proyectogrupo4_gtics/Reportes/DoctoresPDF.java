...
public class DoctoresPDF {

    private List<Doctor> listaDoctores;

    public DoctoresPDF(List<Doctor> listaDoctores) {
    ...
    private void escribirDatosDeLaTabla(PdfPTable tabla) {
        for (Doctor doctor : listaDoctores) {
            tabla.addCell(String.valueOf(doctor.getIdDoctor()));
            tabla.addCell(doctor.getName());
            tabla.addCell(doctor.getLastName());
            tabla.addCell(doctor.getHeadquarter());
            tabla.addCell(doctor.getEmail());
            tabla.addCell(doctor.getCreationDate().toString());
            tabla.addCell(doctor.getState());
        }
    }
    ...
    public void exportar(HttpServletResponse response) throws DocumentException, IOException {
        ...
        Paragraph titulo = new Paragraph("Lista de Doctores",fuente);
