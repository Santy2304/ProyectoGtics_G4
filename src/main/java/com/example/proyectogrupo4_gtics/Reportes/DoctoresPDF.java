...
public class DoctoresPDF {
    ...
    public DoctoresPDF(List<Doctor> listaDoctores,String titulo) {
    ...
    private void escribirDatosDeLaTabla(PdfPTable tabla) {
        ...
        for (Doctor d : listaDoctores) {
            ...
            celda = new PdfPCell(new Phrase(d.getHeadquarter(), fuente));
            celda.setHorizontalAlignment(Element.ALIGN_CENTER);
            tabla.addCell(celda);
            ...
            celda = new PdfPCell(new Phrase(d.getCreationDate().toString(), fuente));
            celda.setHorizontalAlignment(Element.ALIGN_CENTER);
            tabla.addCell(celda);
