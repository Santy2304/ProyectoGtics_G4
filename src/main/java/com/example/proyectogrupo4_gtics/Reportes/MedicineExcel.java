...
public class MedicineExcel {
    ...
    public MedicineExcel(List<CantidadMedicamentosDTO> listaMedicamentos,String titulo) {
        this.titulo = titulo;
    ...
    public void datosTabla() {
        ...
        for (CantidadMedicamentosDTO medicamentosDTO : listaMedicamentos){
            ...
            celda.setCellValue(String.format("%.2f", medicamentosDTO.getPrecio()));
            celda.setCellStyle(estilo);
        ...
        Row filaFecha = hoja.createRow(nueroFilas + 1);
        ...
        hoja.addMergedRegion(new CellRangeAddress(nueroFilas + 1, nueroFilas + 1, 0, 5));
    }
